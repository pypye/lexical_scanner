...
def or_rule(r: AutomataGraph, s: AutomataGraph):
    ...
    data = {
        ...
        "transitions": [
            ["0", "E", clone_r.initial_state],
            ["0", "E", clone_s.initial_state], 
        ] + clone_r.transitions + clone_s.transitions + [
            [clone_r.accepting_states[0], "E", accepting_state],
            [clone_s.accepting_states[0], "E", accepting_state]
        ]
    }
    return AutomataGraph(data)
...
def multiplier_rule(r):
    ...
    data = {
        ...
        "transitions": clone_r.transitions + [
            ["0", "E", clone_r.initial_state],
            [clone_r.accepting_states[0], "E", clone_r.initial_state],
            [clone_r.accepting_states[0], "E", accepting_state],
            ["0", "E", accepting_state],
        ]
    }
